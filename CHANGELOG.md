...
- Added update scripting to manage easy update of templates going forward
- Updated all templates to latest Vite template dependencies and Mapbox dependencies

##  0.1.1

 - Fix `cp` command usage which fails on Windows machines - uses Node.js' native `cp` command instead.