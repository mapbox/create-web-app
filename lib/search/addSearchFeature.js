...
function getSearchAppFilePath(framework) {
  const frameworkPaths = {
    ...
    'angular': `templates/shared/search-enabled-apps/${framework}/map.component.ts`,
    'vanilla': `templates/shared/search-enabled-apps/${framework}/index.html`
  };
...
function getAppFilePath(framework, projectName) {
  const frameworkPaths = {
    ...
    'vanilla': `${projectName}/index.html`
  };
